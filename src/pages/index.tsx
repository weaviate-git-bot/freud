...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-beige100 px-8 pb-8">
        ...
        <form onSubmit={handleSubmit} className="mb-0 flex flex-row gap-3 w-[80%] mt-8">
          <TextArea
